...
def play_welcome_message(student_name):
    ...
    try:
        ...
        # Set a flag to indicate the message has been played
        message_played = True

    except Exception as e:
        print(f"An error occurred: {e}")
        message_played = False  # Message failed to play
...
id = -1
imgStudent = []
message_played = False  # Initialize the message flag to False
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                if secondsElapsed > 50:
                    ...
                    play_welcome_message(student_name)

            if modeType != 3:
                if 10 < counter < 20:
                    modeType = 2
                    message_played = play_welcome_message(studentInfo['name'])
                ...
                if counter <= 10:
                    ...
                    cv2.putText(imgBackground, str(id), (1006, 493),
                                cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['Course']), (970, 625),
